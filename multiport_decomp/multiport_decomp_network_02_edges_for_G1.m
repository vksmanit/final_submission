...
% multiport network 02. The edgeId may be different by name.  
% --------------------------------------------------------------------------------

     [modified_edges_for_network_02, port]  = multiport_decomp_network_02(cktnetlist);
    ...
    % nodes_to_be_mergers_for_g1 = modified_edges_for_network_02(end:-1:end - length(common_nodes_index) + 2, :);
     nodes_to_be_mergers_for_g1 = modified_edges_for_network_02(end:-1:end-port+ 1,:);
