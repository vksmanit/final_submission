function [edges, g1_of_A] = multiport_decomp_nodeInfo_with_edge_identity_of_A(cktnetlist)
% --------------------------------------------------------------------------------
% Syntax : [edges, g1_of_A] = multiport_decomp_nodeInfo_with_edge_identity_of_A(cktnetlist)
%
% This will return a cell object g1_of_A which is a column vector having information 
% that each row represent the node number and entry to each row corresponds to the
% edge identity of graph of G.A.
% --------------------------------------------------------------------------------
